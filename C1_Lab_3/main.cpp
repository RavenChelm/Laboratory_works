...
int main()
{
    ...
    std::cout << "Введите путь для создания файлла исходных данных:\n> ";
    ...
    std::cout << "Введите название и тип данных:\n> ";
    ...
    if (!original.is_open())
        ...
        Group list[size];
        std::cout << "Заполните построчно таблицу группы:\n\n";
            ...
            if (!sorted.is_open())
                ...
                if (!res.is_open())
                    ...
                    for(int i = 0; i < counter; i++)
                        print(final, i);
                    std::cout << "\n\nnСтудентов, удовлетворяющих условию: " << counter << "\n";
                }
            }
        }
    }
